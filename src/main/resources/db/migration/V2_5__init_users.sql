...
UPDATE doctor SET id = 1 WHERE pesel = '12345678912';
UPDATE doctor SET id = 2 WHERE pesel = '12345678913';
UPDATE doctor SET id = 3 WHERE pesel = '22345678913';

UPDATE patient SET id = 5 WHERE pesel = '12345678412';
UPDATE patient SET id = 6 WHERE pesel = '12345672913';
UPDATE patient SET id = 7 WHERE pesel = '22345600913';
